...
int main(){
    ...
    char doc[LONGEST_DOC+1];
    int numOfWords=removePunc("**** 2018 ****",doc);
    char docCopy[numOfWords][MAX_WORD_LENGTH+1];
    toArray(doc,docCopy);
...
int rate(const char document[],
    ...
    const int wordCount=removePunc(document,alphaSpace);
